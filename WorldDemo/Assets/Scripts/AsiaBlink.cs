...
public class AsiaBlink : MonoBehaviour
{
    ...
    ColorBlock cb;
    public Button Dubai; //image to toggle
    public Button India; //image to toggle
    public Button Seoul; //image to toggle
    public Button Shanghai; //image to toggle  
    public Button Hongkong; //image to toggle 
    public Button Tokyo; //image to toggle 
        ...
        else
        {
            ...
            switch (output)
            {
                ...
                case "4":
                    ...
                    break;
                case "5":
                    SceneManager.LoadScene("Hongkong");
                    break;
                case "6":
