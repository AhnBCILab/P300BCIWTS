...
#        global file_exist, file1, file2, channelNum
        eegData_txt = 'WorldSystem/Zero/CNNtemp/eegData.out'
        stims_txt = 'WorldSystem/Zero/CNNtemp/stims.out'
        start_txt = 'WorldSystem/Zero/CNNtemp/start.out'
        moveData_eeg = 'WorldSystem/Zero/Online/Data/txt_files/eegData/'
        moveData_stims = 'WorldSystem/Zero/Online/Data/txt_files/stims/'
        ...
        for i in range(0, 12):
            ...
            #Downsampling
            eegData = Re_referencing(eegData[channelIdx], channelNum, sampleNum)
